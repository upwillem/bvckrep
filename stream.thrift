...
service Stream
{
	...
	binary GetStream(1:string sender, 2:string recipient, 3:string connectId, 4:bool audio),
	binary GetVideo(1:string sender, 2:string recipient, 3:string connectId, 4:bool audio)
}